...
<html lang="en">
  <head>
    ...
    <title>Dashboard PIC Regional</title>
  </head>
  <body>
    <!-- START NAVBAR-->
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background-color: rgb(212, 79, 79) ">
        <div class="container">
          <a class="navbar-brand" href="home_picregion.php">DASHBOARD PIC REGIONAL</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="home_picregion.php">HOME</a>
              </li>
			  <li class="nav-item">
     ...
     <section id="welcome">
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="col-md-4">
                    <p>Selamat anda telah berhasil login sebagai PIC Regional</p>
                </div>
            </div>
        </div>
