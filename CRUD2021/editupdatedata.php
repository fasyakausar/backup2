...
<!--start update form -->
  ...
  <div class="card-body">
	  ...
	  <div class="form-group">
  			...
  			<input type="text" name="nama_lengkap" value="<?=@$vnamalengkap?>" class="form-control" placeholder="Input Nama Lengkap Baru" required>
  		</div>
  		...
  		<div class="form-group">
  			...
  			<input type="text" name="kata_sandi" value="<?=@$vnim?>" class="form-control" placeholder="Input Password Baru" required>
  		</div>
