...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background-color: rgb(221, 60, 60)">
      <div class="container">
        <a class="navbar-brand" href="page_regional.php">Dashboard PIC Regional</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Witel</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Reward TREG</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link active dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"> We Care </a>
              ...
              <li class="nav-item">
                <a class="btn btn-dark" aria-current="page" href="logout_regional.php">LOGOUT</a>
              </li>
            </li>
          </ul>
        </div>
